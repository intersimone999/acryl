 ...
 */
@Deprecated
public class MissingSpecificVersionCheckDetector extends SingleRuleViolationDetector {
...
//        }
    ...
    public CombinedViolationDetector.RuleViolationReport buildReport(
        ...
        if (alternativeApis.containsAll(usedApis)) {
            ...
            messageBuilder.append("The APIs you are using must be used in a different way in a set of Android releases (")
            ...
            messageBuilder.append("The APIs you are using must be used only in a set of Android versions (")
                    .append(checkToImplement.toString())
                    .append("). Check the Android version before using them. ");
        } else {
            messageBuilder.append("You should use different APIs in a set of Android versions (")
                    .append(checkToImplement.toString())
                    .append("). Use these APIs instead: ")
                    .append(alternativeApisString)
                    .append(".");
